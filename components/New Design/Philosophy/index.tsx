      ...
      <div className=' grid  mb-16  grid-cols-1 gap-y-5 lg:gap-y-0 lg:grid-cols-3 gap-x-10 place-items-center '>
        ...
        {features.slice(0, 9).map((item) => {
          return (
            <div
              key={item.id}
              className='bg-white w-full hover:shadow-2xl duration-500 lg:h-[20rem] shadow-md p-6 rounded-[20px] items-center'
            >
...
const features = [
  ...
  },
  {
    id: 3,
    title: "core values",
    content: "·Collaboration ·Integration ·Efficiency ·Sustainability.",
