...
const Footer = () => {
  return (
    <footer className='lg:px-400 lg:pt-120half bg-newgreen'>
      <div className='bg-white rounded-[40px] lg:p-10 relative flex justify-around'>
        <div className=' w-1/3'>
          <Logo color='black' />
          <h3 className='mt-10 mb-7 capitalize font-bold lg:text-3xl  text-newgreen'>
            Contact Us
          </h3>
        ...
        <div className='flex flex-col'>
          ...
          ></iframe>
          <div className='lg:mt-10  text-newgreen'>
            <h3 className='capitalize font-bold lg:text-3xl mb-2'>
              contact address
            </h3>
